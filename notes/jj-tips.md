...
jj git init .
jj describe
jj git remote add origin git@github.com:winksaville/vc-x1-work-repo-template
...
Complete example:
```
wink@3900x 26-03-13T17:26:21.177Z:~/data/prgs/rust/vc-x1-work-repo-template ((jj/keep/1a79f803025f75fb557a7b6f9d29e3dbee6a1724))
$ vi README.md 
wink@3900x 26-03-13T17:28:08.833Z:~/data/prgs/rust/vc-x1-work-repo-template ((jj/keep/1a79f803025f75fb557a7b6f9d29e3dbee6a1724))
$ jj log
...
~
wink@3900x 26-03-13T17:28:15.704Z:~/data/prgs/rust/vc-x1-work-repo-template ((jj/keep/1a79f803025f75fb557a7b6f9d29e3dbee6a1724))
$ jj git push
...
wink@3900x 26-03-13T17:28:33.741Z:~/data/prgs/rust/vc-x1-work-repo-template ((main))
```
...
be "docs":
```
wink@3900x 26-03-13T17:32:17.819Z:~/data/prgs/rust/vc-x1-work-repo-template ((jj/keep/1a79f803025f75fb557a7b6f9d29e3dbee6a1724))
$ jj log -r ::@
...
wink@3900x 26-03-13T17:57:13.692Z:~/data/prgs/rust/vc-x1-work-repo-template ((main))
...
wink@3900x 26-03-13T17:57:27.856Z:~/data/prgs/rust/vc-x1-work-repo-template ((jj/keep/1a79f803025f75fb557a7b6f9d29e3dbee6a1724))
Rebased 1 descendant commits
Working copy  (@) now at: vnsyoswv 1b6ed25c docs: Update README.md
Parent commit (@-)      : vuwzvmwm 1a79f803 feat: Initial commit for the vibe coding main repo
wink@3900x 26-03-13T17:58:34.975Z:~/data/prgs/rust/vc-x1-work-repo-template ((jj/keep/1a79f803025f75fb557a7b6f9d29e3dbee6a1724))
$ jj log
...
│  feat: Initial commit for the vibe coding main repo
~
wink@3900x 26-03-13T18:15:39.052Z:~/data/prgs/rust/vc-x1-work-repo-template ((jj/keep/1a79f803025f75fb557a7b6f9d29e3dbee6a1724))
$ jj log -r ::main
○  plkoouwq wink@saville.com 2026-03-13 10:58:34 main* bc66029d
│  docs: Update README.md with force push example
@  vnsyoswv wink@saville.com 2026-03-13 10:57:53 1b6ed25c
...
│  feat: Initial commit for the vibe coding main repo
◆  zzzzzzzz root() 00000000
wink@3900x 26-03-13T18:17:20.926Z:~/data/prgs/rust/vc-x1-work-repo-template ((jj/keep/1a79f803025f75fb557a7b6f9d29e3dbee6a1724))
$ jj git push --bookmark main
Changes to push to origin:
...
wink@3900x 26-03-13T18:19:07.922Z:~/data/prgs/rust/vc-x1-work-repo-template ((jj/keep/1b6ed25cf716ba3686bed15085f0463590a6200c))
$ 
wink@3900x 26-03-13T18:22:21.776Z:~/data/prgs/rust/vc-x1-work-repo-template ((jj/keep/1b6ed25cf716ba3686bed15085f0463590a6200c))
$ jj new main
...
Added 0 files, modified 1 files, removed 0 files
wink@3900x 26-03-13T18:25:23.243Z:~/data/prgs/rust/vc-x1-work-repo-template ((main))
$ jj log -r ::@
...
│  feat: Initial commit for the vibe coding main repo
◆  zzzzzzzz root() 00000000
wink@3900x 26-03-13T18:25:46.005Z:~/data/prgs/rust/vc-x1-work-repo-template ((main))
$
```
