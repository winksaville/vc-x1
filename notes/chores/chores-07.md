...
- `CLAUDE.md`: extension paragraph under `### Versioning`
  (merged at rebase with the icr-side decomposition pointer).
  Points at `notes/substep-protocol.md` (full procedure) and
